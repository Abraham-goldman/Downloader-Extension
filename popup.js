document.addEventListener('DOMContentLoaded', function() {
    ...
    const quotes = [
        ...
        "\"در مشکلات زندگی مانند دکتر نیک سرشت باشید، اهمیتی ندید :) - اکثریت دانشجو ها\"",
        ...
        "\"قول میدم این دفعه داره فرق، نیستم من مثل سال قبل – 🍀 بهزاد لیتو\"",
        "\"بذار رک اینو بگم بهت ساده، از آسمون خدا تو رو فرستاده – 🍀 بهزاد لیتو\"",
        "\"با اینستای مخفی توو پیجت میرم، میپامت از صد متری باز – 🍀 بهزاد لیتو\"",
        "\"الو سامان خودتی؟ – 🌟 رضا پیشرو\"",
        "\"تنها تو لحظات پر از تشنگی، خودم شدم واسه خودم جبرئیل – 🌟 رضا پیشرو\"",
        "\"حتی اگه همو خوشحالم کنین، روزگار حمله میکنه گاز انبری – 🌟 رضا پیشرو\"",
        "\"عاشق کاریم که وای میستیم توی جاده تاریک، نمیتونی با یه واژه باشی واسه دلداریم – 🌟 رضا پیشرو\"",
        "\"یه مقدونیه مون نشه؟ – 🌿 کوروش کبیر\"",
        "\"هندی نیستم، ولی هندوستان رو دوست دارم. – 🌿 نادر شاه\"",
        "\"سلاممم فرمانده. – 🌟 ابوذر روحی\"",
        "\"هنر اینه که سینه رو عالی دادی جلو – 🌟 حصین\"",
        "\"به چشم من تو اون کوهی، پر غروری بی نیازی با شکوهی – 🌹 گوگوش\"",
        ...
        "\"فوتبال یک بازی است که شما باید از آن لذت ببرید و همه چیز را برای تیم بگذارید. – ⚽ کریم بنزما\"",
        "\"تغییرات از آن کسانی است که منتظر آن نیستند، بلکه کسانی که برای آن می‌جنگند. – 💩 باراک اوباما\"",
        "\"بله، ما می‌توانیم! (Yes, we can!) – 💩 باراک اوباما\"",
        "\"آمریکا همیشه در حال تغییر است و ما باید به آنچه که می‌خواهیم، برسیم. – 💩 باراک اوباما\"",
        "\"حقوق بشر حقوق زنان است و حقوق زنان حقوق بشر است. – 💩 هیلاری کلینتون\"",
        "\"آمریکا هیچ‌گاه به عقب برنمی‌گردد. – 💩 هیلاری کلینتون\"",
        "\"شجاعت به معنای ایستادگی برای آنچه درست است، حتی اگر تنها باشید. – 💩 هیلاری کلینتون\"",
        "\"👑دختری از امت عیسی دلم را برده است یا محمد همتی ده تا مسلمانش کنم. – 👑دکتر باقری\"",
        "\"!!!Alright – دکتر برهانی حقیقی 👨🏻‍🔬🤔💭🔢\"",
        "\"پنج ابتدایی – دکتر برهانی حقیقی 👨🏻‍🔬🤔💭🔢\"",
        "\"ای دل ار سیل فنا بنیاد هستی برکند، چون تو را نوح است کشتیبان غم مخور – دکتر برهانی حقیقی 👨🏻‍🔬🤔💭🔢\"",
        "\"$$$ – دکتر زارعی 👨🏻‍🔬🤔💭🔢\"",
        "\"احتمال وجود حیات در کهکشان، از شانس پاس شدن شما بیشتر است. – دکتر محمدی 👱🏻‍♀️\"",
        "\"به جای دانلود فایل کلاس ها، یه سریال خوب دانلود کن، کی درس میخونه آخه؟؟!! – یه دوست\"",
        "\"جنگ تمام شدنی نیست. – حاج قاسم\""
    ];
